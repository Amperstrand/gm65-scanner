...
fn init_hardware() -> Hardware {
    ...
    // start regardless of how we got here. See ccid-firmware-rs issue #15.
    {
        ...
        // address on STM32F469 (RM0090 §30). We access it before the USB driver
        // takes ownership, using volatile reads/writes for register-level reset
        // sequencing. No aliasing — the driver hasn't been created yet.
        unsafe {
